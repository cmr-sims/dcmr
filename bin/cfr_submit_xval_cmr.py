#!/usr/bin/env python
#
# Print commands to run cross-validation of CFR data.
...
def main(
    ...
    print(f'cfr_xval_cmr.py {inputs} {fcf_features} {ff_features} {full_dir} {opts}')


if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        description='Print commands to run cross-validation for multiple models.'
    )
    ...
    parser.add_argument('--n-folds', '-d', type=int)
    parser.add_argument('--fold-key', '-k')
