...
def get_param_latex():
    ...
    latex_names = {
        ...
        'B_disrupt_loc': r'\beta_{\mathrm{disrupt},I}',
        'B_disrupt_cat': r'\beta_{\mathrm{disrupt},C}',
        ...
        'Lfc': 'L^{FC}',
        'Lfc_loc_raw': r'L^{FC}_I',
        'Lfc_cat_raw': r'L^{FC}_C',
        'Lfc_use_raw': r'L^{FC}_D',
        'Lcf': 'L^{CF}',
        'Lcf_loc_raw': r'L^{CF}_I',
        'Lcf_cat_raw': r'L^{CF}_C',
        'Lcf_use_raw': r'L^{CF}_D',
        'Acf': 'A^{CF}',
        'Aff': 'A^{FF}',
        'Dff': 'D^{FF}',
